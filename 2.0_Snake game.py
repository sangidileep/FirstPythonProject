...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Shubham Snake And Apple Game")
    ...
    def show_game_over(self):
        self.render_background()
        font = pygame.font.SysFont('arial', 30)
        line1 = font.render(f"Game is over! Your score is {self.snake.length}", True, (21, 17, 51))
        self.surface.blit(line1, (200, 300))
        line2 = font.render("To play again press Enter. To exit press Escape!", True, (64, 53, 150))
